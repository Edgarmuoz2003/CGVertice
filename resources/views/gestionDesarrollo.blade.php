...
<head>
    ...
    <title>Gestion de Desarrollo Empresarial</title>
...
<body>
    ...
    <img src="/img/img.jpeg" alt="Imagen de referencia Gestion de desarrollo" class="imgGEstionD">


    <!-- boton de cambio de color de la pantalla -->
    <svg class="d-none">
