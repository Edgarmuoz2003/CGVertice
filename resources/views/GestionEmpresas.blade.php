...
<head>
    ...
    <title>Gestión de Empresas Educativas || Corporate Group Vértice</title>
    ...
    <main class="container">
        ...
        <section style="background-color: #eee;">
            <div class="text-center container py-5">
                <h4 class="mt-4 mb-5 text-dark"><strong>Gestión de Empresas Educativas</strong></h4>
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card">
                            ...
                            <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                                ...
                                <img src="img/9.jpg" class="w-100 img-fluid" />
                                <a>
                                    <div class="mask">
