<div class="container">
    <h3 class="text" style="color:#b8860b">Converge</h3>
    <hr>
    <!-- Div del carrucel con las noticias Destacado -->
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner"  style="padding-left:7%;">
            <!-- item activo del carrucel con las noticias Destacado -->
            <div class="carousel-item active" >
                <div class="row mb-2">
                    <!-- Primera noticia del carrucel con las noticias Destacado -->
                    <div class="col-md-6">
                        <div class="position-relative">
                            <div class="col-md-8 p-4 d-flex flex-column position-static" style="border: #b8860b 1px solid; margin-left:15%;">
                                ...
                                <p class="card-text mb-auto text-white">
                                    ...
                                    descubrir por qué y aprender estrategias para tomar decisiones asertivas?
                                </p>
                                <br>
                                <!-- Video de la carta -->
                        ...
                        <div class="row g-0 overflow-hidden flex-md-row mb-4 h-md-250 position-relative">
                            <div class="col-md-8 p-4 d-flex flex-column position-static" style="border: #b8860b 1px solid; margin-left:15%;">
                                ...
                                <p class="card-text mb-auto text-white">
                                    ...
                                    Digital en las Empresas? Únete a nosotros y explora junto a la rectora de COMPUEDU
                                    los procesos de prácticas.
                                </p>
                                <br>
                        ...
                        <div class="row g-0 overflow-hidden flex-md-row mb-4 h-md-250 position-relative">
                            <div class="col-md-8 p-4 d-flex flex-column position-static" style="border: #b8860b 1px solid; margin-left:15%;">
                                ...
                                <p class="card-text mb-auto text-white">
                                    ...
                                    oportunidad de aprender de un experto en el campo. ¡Haz clic para ver el video ahora
                                    mismo,
                                </p>
                                <br>
                                <!-- Aquí colocamos el video de YouTube -->
