        ...
        <div class="maintabsQuienessomos">
            ...
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="3-tab" data-bs-toggle="tab" data-bs-target="#three-tab-pane"
                        type="button" role="tab" aria-controls="3-tab-pane" aria-selected="false">Diseño Interno</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active text-black" id="one-tab-pane" role="tabpanel" aria-labelledby="1-tab"
                    ...
                    <br>
                    <br>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur voluptatibus maiores harum saepe, quam quis nulla facilis, est expedita accusamus sint eaque, aspernatur ipsum earum iure. Ducimus obcaecati odio sit?</p>
                </div>
                <div class="tab-pane fade show active text-black" id="two-tab-pane" role="tabpanel" aria-labelledby="2-tab"
                    tabindex="0">
                    <br>
                    <br>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur voluptatibus maiores harum saepe, quam quis nulla facilis, est expedita accusamus sint eaque, aspernatur ipsum earum iure. Ducimus obcaecati odio sit?</p>
