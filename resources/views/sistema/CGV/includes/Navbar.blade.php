        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('inicio') }}" class="nav-link" aria-current="page" style="color: #bf943a; font-weight: 500;">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('nosotros') }}" style="color: #bf943a; font-weight: 400;">Nosotros</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ruta_blog') }}" style="color: #bf943a; font-weight: 400;">Converge</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ruta_V2') }}" style="color: #bf943a; font-weight: 400;">V2suministros</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active menu-servicios" href="{{ route('ruta_services') }}" style="color: #bf943a; font-weight: 400;">Servicios</a>
                    </li>
                </ul>
