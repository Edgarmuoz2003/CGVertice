        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary px-4 mb-3">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" aria-disabled="true">
                    <img src="../img/V2logo.jpeg" alt="V2 Suministros" class="img-fluid me-5" width="50" height="auto">
                </a>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav nav-underline me-auto mb-0 mb-lg-0">
                        <div class="nav nav-underline me-auto mb-0 mb-lg-0">
                            <div class="nav-item">
                                <a class="nav-link me-2" href="../V2/">Inicio</a>
                            </div>
                        </div>
                        <div class="nav nav-underline me-auto mb-0 mb-lg-0">
                            <div class="nav-item">
                                <a class="nav-link me-2" href="../">CGVértice</a>
                            </div>
                        </div>
                    </ul>
                    <form class="d-flex me-3" role="search">
                        <input class="form-control me-3" type="search" placeholder="¿Qué estás buscando?" aria-label="Search">
                        <button class="btn btn-outline-danger me-3" type="submit">Buscar</button>
                    </form>
